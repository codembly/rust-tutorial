...
fn main() {
    ...
    let var = 10;
    println!("Codembly! The integer number is: {} ", var);
    // The statement below specify to the compiler the var is of integer data type
    let _var1:i32 =  10;
    println!("Codembly! The integer number is: {} ", _var1);
    ...
    //_var2 = _var2 + 1;
    //println!("Codembly! The integer number is: {} ", _var2);
    ...
    println!("Codembly! The floating point numbers are: {:.1} and {:.2}", _var3, _var4);
    // Boolean type example printing boolean values
    let _var5 = true;
    let _var6:bool = false; //explicit type annotation
    println!("Codembly! The boolean value are: {} and {}", _var5, _var6);
    // Unicode scalar type example char types
    let _var7 = 'z';
    let _var8:char = 'X'; //explicit type annotation
    println!("Codembly! The chars are: {} and {}", _var7, _var8);
    let _snowman:char = '☃';
    println!("Codembly! The snowman symbol is {}", _snowman);
}
